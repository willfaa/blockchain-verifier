            ...
            <div className="flex flex-col gap-2 text-sm text-slate-300">
              ...
              <div className="flex flex-col gap-2">
                <input
                  ...
                  className="w-full rounded-lg border border-white/15 bg-slate-900/70 px-3 py-2.5 text-sm text-white outline-none ring-0 placeholder:text-slate-500 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-500/40"
                />
                <button className="w-full rounded-lg bg-linear-to-r from-fuchsia-500 to-orange-400 py-2.5 text-sm font-semibold text-slate-950 shadow-md shadow-fuchsia-500/25 transition hover:-translate-y-0.5">
                  Subscribe
                </button>
              </div>
            </div>
